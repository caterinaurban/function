...
let ctl_ast_testcases =
  ...
  >::: [ test_ast ~joinbwd:4 "./tests/ctl/global_test_simple.c"
       ...
       ; (* NOTE: Currently can't use BOXES domain because of missing
            underapproximation support *)
         (* test ~domain:BOXES "./tests/ctl/until_test.c" "AF{x < y + 20}"
            false; *)
       ...
       ; test_ast ~precondition:"n > 0" "./tests/ctl/and_test.c"
           "EG{EF{n==1}}" true
       ; test_ast "./tests/ctl/or_test.c" "OR{AF{AG{x < -100}}}{AF{x==20}}"
           true
       ; test_ast "./tests/ctl/or_test.c" "OR{EF{AG{x < -100}}}{AF{x==20}}"
           true
       ; test_ast "./tests/ctl/or_test.c" "OR{AF{EG{x < -100}}}{AF{x==20}}"
           true
       ; test_ast "./tests/ctl/or_test.c" "OR{EF{EG{x < -100}}}{AF{x==20}}"
           true
