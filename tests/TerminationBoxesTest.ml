...
(* let (@=>) = (=>) ~setup:["-ctl_cfg"; "AF{exit: true}"] *) 
(* let (@@=>) (filename, conditionalTerminationProperty) = *) 
(*   (=>) ~setup:["-ctl_cfg"; "AF{exit: true}"; "-precondition"; conditionalTerminationProperty] filename *) 
(* let (@@+=>) (filename, conditionalTerminationProperty) = *) 
(*   (=>) ~setup:["-ctl_cfg"; "AF{exit: true}"; "-joinbwd"; "5" ;"-precondition"; conditionalTerminationProperty] filename *) 
...
[
  ...
  "./tests/example2a.c" -=> true; (* -refine *)
  "./tests/example2b.c" -=> true; (* -refine *)
  "./tests/example2c.c" -=> true; (* -refine *)
  "./tests/example2d.c" -=> true; (* -refine *)
  "./tests/example2e.c" -=> true; (* -refine *)
  ...
  "./tests/sorting4.c" -- true; (* polyhedra *)
  "./tests/tacas2013a.c" => true;
  "./tests/tacas2013b.c" -- true; (* polyhedra *)
