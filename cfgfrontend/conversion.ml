...
(* Some utility functions to convert from new Cfg expressions to old
   AbstractSyntax expressions NOTE: this quite a mess, ideally one would
   unify the two syntaxes but this is a lot of work *)

let varId_of_var (var : ControlFlowGraph.var) =
  "$" ^ string_of_int var.var_id
