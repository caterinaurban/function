...
./function tests/ctl/existential_test3.c -domain polyhedra -ctl "EF{r==1}" -precondition "x > 0" > logs/ctl/existential_test3_1CFG#TODO.log		# TODO: ?
...
./function tests/ctl/fin_ex.c -domain polyhedra -ctl "EF{n==1}" -precondition "n > 0" > logs/ctl/fin_ex_1CFG#TODO.log							# TODO: ?
./function tests/ctl/fin_ex.c -domain polyhedra -ctl "EG{EF{n==1}}" -precondition "n > 0" > logs/ctl/fin_ex_2CFG#TODO.log						# TODO: ?
./function tests/ctl/global_test_simple.c -domain polyhedra -ctl "AG{AF{x <= -10}}" -joinbwd 6 > logs/ctl/global_test_simple_1CFG#TODO.log		# TODO: ?
./function tests/ctl/global_test_simple.c -domain polyhedra -ctl "EG{AF{x <= -10}}" -joinbwd 6 > logs/ctl/global_test_simple_2CFG#TODO.log		# TODO: ?
./function tests/ctl/global_test_simple.c -domain polyhedra -ctl "AG{EF{x <= -10}}" -joinbwd 6 > logs/ctl/global_test_simple_3CFG#TODO.log		# TODO: ?
./function tests/ctl/global_test_simple.c -domain polyhedra -ctl "EG{EF{x <= -10}}" -joinbwd 6 > logs/ctl/global_test_simple_4CFG#TODO.log		# TODO: ?
...
./function tests/ctl/potential_termination_1.c -domain polyhedra -ctl "EF{exit: true}" > logs/ctl/potential_termination_1CFG#TODO.log			# TODO: ?
./function tests/ctl/until_existential.c -domain polyhedra -ctl "EU{x >= y}{x == y}" -precondition "x > y" > logs/ctl/until_existential_1CFG#TODO.log	# TODO: ?
./function tests/ctl/until_existential.c -domain polyhedra -ctl "EF{AG{x == y}}" -precondition "x > y" > logs/ctl/until_existential_2CFG#TODO.log		# TODO: ?
...
# ./function tests/ctl/koskinen/toylin1.c -domain polyhedra -ctl "AF{resp > 5}" -precondition "c > 5" > logs/ctl/toylin1CFG.log					# TODO: ?
 ./function tests/ctl/koskinen/win4.c -domain polyhedra -ctl "AF{AG{WItemsNum >= 1}}" > logs/ctl/win4CFG#TODO.log										# TODO: ?
...
./function tests/ctl/ltl_automizer/coolant_basis_1_unsafe_sfty.c -domain polyhedra -ctl "AG{OR{chainBroken != 1}{AG{chainBroken == 1}}}" -precondition "chainBroken == 0" > logs/ctl/coolant_basis_1_unsafe_sftyCFG#FIX.log		# TODO: not supposed to be true?
./function tests/ctl/ltl_automizer/coolant_basis_2_safe_lifeness.c -domain polyhedra -ctl "AG{AF{otime < time}}" > logs/ctl/coolant_basis_2_safe_lifenessCFG#TODO.log	# TODO: ?
...
./function tests/ctl/ltl_automizer/coolant_basis_3_unsafe_sfty.c -domain polyhedra -ctl "AG{OR{init != 3}{AG{AF{time > otime}}}}" -precondition "init == 0" > logs/ctl/coolant_basis_3_unsafe_sftyCFG#FIX.log	# TODO: not supposed to be true?
...
./function tests/ctl/ltl_automizer/coolant_basis_5_safe_cheat.c -domain polyhedra -ctl "AU{init == 0}{OR{AU{init == 1}{AG{init == 3}}}{AG{init == 1}}}" -precondition "init == 0" > logs/ctl/coolant_basis_5_safe_cheatCFG#TODO.log	# TODO: ?
./function tests/ctl/ltl_automizer/coolant_basis_5_safe_sfty.c -domain polyhedra -ctl "AU{init == 0}{OR{AU{init == 1}{AG{init == 3}}}{AG{init == 1}}}" -precondition "init == 0" > logs/ctl/coolant_basis_5_safe_sftyCFG#TODO.log	# TODO: ?
...
./function tests/ctl/ltl_automizer/coolant_basis_6_safe_sfty.c -domain polyhedra -ctl "AG{OR{limit <= -273 && limit >= 10}{OR{tempIn >= 0}{AF{ warnLED == 1}}}}" -precondition "init == 0 && temp < limit" > logs/ctl/coolant_basis_6_safe_sftyCFG#TODO.log	# TODO: ?
...
./function tests/ctl/report/test_existential3.c -domain polyhedra -ctl "EF{r==1}" -precondition "x > 0" > logs/ctl/test_existential3_2CFG#TODO.log
./function tests/ctl/report/test_existential3.c -domain polyhedra -ctl "EF{r==1}" -precondition "x > 0" -ctl_existential_equivalence > logs/ctl/test_existential3_2CFG_exeq.log
./function tests/ctl/report/test_global.c -domain polyhedra -ctl "AF{AG{y > 0}}" -precondition "x < 10" > logs/ctl/test_globalCFG#TODO.log		# TODO: ?
...
./function tests/ctl/t2_cav13/P3.c -domain polyhedra -ctl "OR{varA != 1}{EF{varR==1}}" -precondition "varA == 0" > logs/ctl/P3CFG#TODO.log	# TODO: ?
...
./function tests/ctl/t2_cav13/P4.c -domain polyhedra -ctl "EF{AND{varA == 1}{AG{varR != 1}}}" -precondition "varN > 0" > logs/ctl/P4CFG.log
 ...
 ./function tests/ctl/sv_comp/Bangalore_false-no-overflow.c -domain polyhedra -ctl "EF{x < 0}" > logs/ctl/Bangalore_false-no-overflowCFG#TODO.log		# TODO: ?
...
./function tests/ctl/sv_comp/java_Sequence_true-termination_true-no-overflow.c -domain polyhedra -ctl "AF{AND{AF{j >= 21}}{i==100}}" > logs/ctl/java_Sequence_true-termination_true-no-overflow_1CFG#TODO.log	# TODO: ?
./function tests/ctl/sv_comp/java_Sequence_true-termination_true-no-overflow.c -domain polyhedra -ctl "AF{AND{EF{j >= 21}}{i==100}}" > logs/ctl/java_Sequence_true-termination_true-no-overflow_2CFG#TODO.log	# TODO: ?
./function tests/ctl/sv_comp/java_Sequence_true-termination_true-no-overflow.c -domain polyhedra -ctl "EF{AND{AF{j >= 21}}{i==100}}" > logs/ctl/java_Sequence_true-termination_true-no-overflow_3CFG#TODO.log	# TODO: ?
./function tests/ctl/sv_comp/java_Sequence_true-termination_true-no-overflow.c -domain polyhedra -ctl "EF{AND{EF{j >= 21}}{i==100}}" > logs/ctl/java_Sequence_true-termination_true-no-overflow_4CFG#TODO.log	# TODO: ?
...
./function tests/ctl/sv_comp/NO_02_false-termination_true-no-overflow.c -domain polyhedra -ctl "AF{AG{j==0}}" > logs/ctl/NO_02_false-termination_true-no-overflow_1CFG#TODO.log	# TODO: ?
./function tests/ctl/sv_comp/NO_02_false-termination_true-no-overflow.c -domain polyhedra -ctl "EF{AG{j==0}}" > logs/ctl/NO_02_false-termination_true-no-overflow_2CFG#TODO.log	# TODO: ?
./function tests/ctl/sv_comp/NO_02_false-termination_true-no-overflow.c -domain polyhedra -ctl "AF{EG{j==0}}" > logs/ctl/NO_02_false-termination_true-no-overflow_3CFG#TODO.log	# TODO: ?
./function tests/ctl/sv_comp/NO_02_false-termination_true-no-overflow.c -domain polyhedra -ctl "EF{EG{j==0}}" > logs/ctl/NO_02_false-termination_true-no-overflow_4CFG#TODO.log	# TODO: ?
...
./function tests/ctl/existential_test3.c -domain polyhedra -ctl "EF{r==1}" -ast -precondition "x > 0" > logs/ctl/existential_test3_1AST#TODO.log		# TODO: ?
...
./function tests/ctl/potential_termination_1.c -domain polyhedra -ctl "EF{exit: true}" -ast > logs/ctl/potential_termination_1AST#TODO.log		# TODO: ?
...
# ./function tests/ctl/ltl_automizer/coolant_basis_1_unsafe_sfty.c -domain polyhedra -ctl "AG{OR{chainBroken != 1}{AG{chainBroken == 1}}}" -ast -precondition "chainBroken == 0" > logs/ctl/coolant_basis_1_unsafe_sftyAST.log		# UNKNOWN?
 ./function tests/ctl/ltl_automizer/coolant_basis_2_safe_lifeness.c -domain polyhedra -ctl "AG{AF{otime < time}}" -ast > logs/ctl/coolant_basis_2_safe_lifenessAST#TODO.log	# TODO: ?
# ./function tests/ctl/ltl_automizer/coolant_basis_2_unsafe_lifeness.c -domain polyhedra -ctl "AG{AF{otime < time}}" -ast > logs/ctl/coolant_basis_2_unsafe_lifenessAST.log	# UNKNOWN
 ./function tests/ctl/ltl_automizer/coolant_basis_3_safe_sfty.c -domain polyhedra -ctl "AG{OR{init != 3}{AG{AF{time > otime}}}}" -ast -precondition "init == 0" > logs/ctl/coolant_basis_3_safe_sftyAST#TODO.log	# TODO: ?
# ./function tests/ctl/ltl_automizer/coolant_basis_3_unsafe_sfty.c -domain polyhedra -ctl "AG{OR{init != 3}{AG{AF{time > otime}}}}" -ast -precondition "init == 0" > logs/ctl/coolant_basis_3_unsafe_sftyAST.log	# UNKNOWN?
 ./function tests/ctl/ltl_automizer/coolant_basis_4_safe_sfty.c -domain polyhedra -ctl "AG{OR{init != 3}{OR{temp <= limit}{AF{AG{chainBroken == 1}}}}}" -ast -precondition "init == 0 && temp < limit" > logs/ctl/coolant_basis_4_safe_sftyAST#TODO.log	# TODO: ?
# ./function tests/ctl/ltl_automizer/coolant_basis_4_unsafe_sfty.c -domain polyhedra -ctl "AG{OR{init != 3}{OR{temp <= limit}{AF{AG{chainBroken == 1}}}}}" -ast -precondition "init == 0 && temp < limit" > logs/ctl/coolant_basis_4_unsafe_sftyAST.log	# TODO: UNKNOWN? + bad performance 
 ./function tests/ctl/ltl_automizer/coolant_basis_5_safe_cheat.c -domain polyhedra -ctl "AU{init == 0}{OR{AU{init == 1}{AG{init == 3}}}{AG{init == 1}}}" -ast -precondition "init == 0" > logs/ctl/coolant_basis_5_safe_cheatAST#TODO.log	# TODO: ?
 ./function tests/ctl/ltl_automizer/coolant_basis_5_safe_sfty.c -domain polyhedra -ctl "AU{init == 0}{OR{AU{init == 1}{AG{init == 3}}}{AG{init == 1}}}" -ast -precondition "init == 0" > logs/ctl/coolant_basis_5_safe_sftyAST#TODO.log	# TODO: ?
# ./function tests/ctl/ltl_automizer/coolant_basis_5_unsafe_sfty.c -domain polyhedra -ctl "AU{init == 0}{OR{AU{init == 1}{AG{init == 3}}}{AG{init == 1}}}" -ast -precondition "init == 0" > logs/ctl/coolant_basis_5_unsafe_sftyAST.log	# UNKNOWN ?
 ./function tests/ctl/ltl_automizer/coolant_basis_6_safe_sfty.c -domain polyhedra -ctl "AG{OR{limit <= -273 && limit >= 10}{OR{tempIn >= 0}{AF{ warnLED == 1}}}}" -ast -precondition "init == 0 && temp < limit" > logs/ctl/coolant_basis_6_safe_sftyAST#TODO.log	# TODO: ?
...
./function tests/ctl/report/test_existential2.c -domain polyhedra -ctl "EF{r==1}" -ast -precondition "x < 200" > logs/ctl/test_existential2AST#TODO.log	# TODO: ?
./function tests/ctl/report/test_existential3.c -domain polyhedra -ctl "EF{r==1}" -ast -precondition "x == 2" > logs/ctl/test_existential3_1AST#TODO.log		# TODO: ?
./function tests/ctl/report/test_existential3.c -domain polyhedra -ctl "EF{r==1}" -ast -precondition "x > 0" > logs/ctl/test_existential3_2AST#TODO.log		# TODO: ?
./function tests/ctl/report/test_existential3.c -domain polyhedra -ctl "EF{r==1}" -ast -precondition "x > 0" -ctl_existential_equivalence > logs/ctl/test_existential3_2AST_exeq#TODO.log		# TODO: ?
...
./function tests/ctl/sv_comp/Bangalore_false-no-overflow.c -domain polyhedra -ctl "EF{x < 0}" -ast > logs/ctl/Bangalore_false-no-overflowAST#TODO.log		# TODO: ?
